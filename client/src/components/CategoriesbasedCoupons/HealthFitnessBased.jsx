...
const HealthFitnessBased = () => {
  return (
    <div className="Health_Fitness">
                <div className="flex flex-col justify-center items-center lg:flex-row lg:justify-between my-10">
                    <div className="flex flex-col gap-1 lg:gap-5">
                        <span className="font-semibold text-lg lg:text-3xl">Today’s Top Health & Fitness Offers</span>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4">
                    {categoriesBasedCoupons.Health_Fitness.map((item, index) => (
                        <div key={index}
