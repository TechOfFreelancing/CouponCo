...
const FoodBeveragesBased = () => {
  return (
    <div className="Food_Beverages">
                <div className="flex flex-col justify-center items-center lg:flex-row lg:justify-between my-10">
                    <div className="flex flex-col gap-1 lg:gap-5">
                        <span className="font-semibold text-lg lg:text-3xl">Today’s Top Food & Beverages Offers</span>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4">
                    {categoriesBasedCoupons.Food_Beverages.map((item, index) => (
                        <div key={index}
