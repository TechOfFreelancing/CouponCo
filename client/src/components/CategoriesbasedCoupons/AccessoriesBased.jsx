...
const AccessoriesBased = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://backend.qwiksavings.com/api/storeDisplay/Accessories"
        )
              ...
              >
                ...
                <span
                  className={`p-2 hidden group-hover:inline-block duration-300 absolute right-1 top-1 rounded-lg bg-gray-300/80 ${
                    role && likedItems.includes(item.coupon_id)
                      ? "text-red-500"
                      : "text-white"
                  }`}
                ...
                <div className='flex flex-col items-center justify-between'>
                  <button
                    ...
                    onClick={() => handleOpen(item, item.type)}
                  >
          ...
          <div className='bg-white p-10 rounded-xl my-5 flex flex-col gap-5'>
            <form className='w-56 max-w-screen-lg lg:w-96 mx-auto'>
              ...
              <span className='text-sm text-black font-extralight'>
                ...
                and{" "}
                <span className='underline font-bold cursor-pointer'>
                  <Link to='/privacy-policy'>Terms & use</Link>
                </span>
              </span>
            </form>
          </div>
