...
const AddEvent = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      formData.append("eventLogoFile", selectedFile ? selectedFile : null)
      formData.append(
        "eventBannerFile",
        selectedBannerFile ? selectedBannerFile : null
      )
        ...
        <Formik initialValues={initialValues} onSubmit={handleSubmit}>
          <Form>
            ...
            <div className='mb-4'>
              ...
              <Field id='best_offer' name='best_offer' style={inputStyle} />
            </div>
            ...
            <div className='mb-4'>
              ...
              <Field id='avg_disc' name='avg_disc' style={inputStyle} />
            </div>
