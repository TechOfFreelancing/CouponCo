            ...
            {coupons.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:w-[97vw] mt-5 xl:mt-10">
                {coupons.map((coupon, index) => (
                  <div key={index} className="border border-gray-300 rounded-lg p-4 mb-4 group relative" onClick={() => navigate("/Admin/updateCoupons", { state: { cId: coupon.coupon_id, sId: coupon.store_id } })}>
