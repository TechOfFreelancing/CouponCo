...
const Alert = () => {
    ...
    return (
        <div className='hidden flex h-10 justify-center gap-2 lg:gap-5 items-center bg-black text-white text-[10px] lg:text-base w-screen z-30 group whitespace-nowrap'>
