    ...
    return (
        <ul className="py-5  mb-4 flex flex-col gap-2 lg:mb-0 lg:flex-row lg:items-center lg:gap-6 text-black">
            ...
            >
                ...
                <div className="hidden lg:block absolute top-0 lg:-left-[27rem] xl:-left-[25.8rem] transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out group-hover:transform z-50 w-[100vw] transform">
            ...
            >
                ...
                <div className="hidden lg:block absolute top-0 lg:-left-[33rem] xl:-left-[31.3rem] transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out group-hover:transform z-50 w-[100vw] transform">
                    <div className="grid grid-cols-5 px-20 gap-5 relative top-6 p-6 bg-white rounded-xl shadow-xl w-full">
                        {
            ...
            >
                ...
                <div className="hidden lg:block absolute top-0 lg:-left-[30rem] xl:-left-[46.3rem] transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out group-hover:transform z-50 w-[100vw] transform">
                    <div className="grid grid-cols-5 px-20 gap-5 relative top-6 p-6 bg-white rounded-xl shadow-xl w-full">
                        {
                            event.map((ele, index) => (
                                <div
