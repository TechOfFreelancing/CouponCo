        ...
        <div className='relative isolate overflow-hidden max-w-[1280px] mx-auto border-t-[1px] border-t-[#B33D53] lg:pt-16'>
          <div className='flex flex-col gap-5 lg:gap-0 lg:flex-row w-full items-start mb-5 justify-between'>
            <div className='flex flex-col w-full lg:w-[25%] items-center justify-center gap-5 lg:-mt-14 p-5 lg:p-0'>
              ...
              <p className='text-black-300 text-justify'>
                Qwik Savings, as the name suggests, is your go-to destination
                for quick savings. It helps you save faster than other websites
                in the market by providing hand-tested coupon codes or offers.
                We guarantee that each of our codes works; if it doesn{`'`}t, we
                {`'`}ll give you a gift card so you can treat yourself on us.
              </p>
            </div>
            {SITEMAP.map((ele, index) => {
              return (
                <div
                  key={index}
                  className='flex flex-col gap-3 items-start lg:items-stretch justify-start pl-5 lg:pl-0'
                >
            ...
            <div className='flex flex-col justify-between h-full'>
              <div className='lg:max-w-lg mt-8 lg:mt-0 flex flex-col gap-3 items-start justify-center max-w-[350px] p-5 lg:pt-0'>
                <h2 className='text-xl tracking-tight text-black whitespace-nowrap font-semibold'>
                  {" "}
                  Join Our Newsletter
                </h2>
          ...
          <div className='flex flex-col text-black justify-between items-center gap-5 p-5'>
            <div className='contact flex flex-col lg:flex-row gap-5 items-center'>
              Disclosure: If you buy a product or service through Qwik Savings,
              we may earn a commission
            </div>
            <div>
              &copy; {new Date().getFullYear()} QwikSavings.com All rights
              reserved.
            </div>
          </div>
        </div>
