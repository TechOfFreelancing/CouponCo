...
import AdminAdvertise from '../components/Admin/AdminAdvertise';
...
const AdminPanel = () => {
    ...
    return (
      <div>
        <h2 className='font-bold md:text-2xl text-base  text-center mt-10 flex items-center justify-center'>
          {" "}
          <hr className='mx-4  md:ml-8 md:mr-4 w-16 h-[3px] bg-black border-0 rounded  ' />
          Welcom to Admin Panel of Coupon Co
          <hr className='mx-4 md:ml-4 md:mr-8 w-16 h-[3px]  bg-black border-0 rounded  ' />
        </h2>
        <div className='italic text-gray-600 text-center'>
          Add, Delete & Modify Coupons as well as stores!
        </div>
        ...
        <div className='buttons text-center'>
          ...
          ${
            selectedButton === "Stores"
              ...
              : "text-gray-800 border-2 border-transparent"
          }  
          `}
