...
const ContactUs = () => {
    ...
    try {
        ...
        const response = await axios.post(`https://backend.qwiksavings.com/api/contact/${localStorage.getItem('id')}`, {
            name: contact.name,
            email: contact.email,
          ...
          <div className='contactform flex flex-col lg:flex-row justify-between lg:items-start lg:w-fit p-5 lg:p-10 rounded-lg bg-white lg:mx-5 mt-5 mb-10 shadow-boxshadow'>
            <div className='w-full lg:w-3/5 flex flex-col gap-5'>
              ...
              <div className='text-justify'>
                ...
                staff will contact you back ASAP regarding your question or
                query. You can also contact us via this Email address:
                <a
            ...
            <div className='w-full lg:w-2/5 h-auto lg:h-[685px] flex flex-col justify-evenly items-center'>
              <img
                src={contactus}
                alt='contact us'
                className='w-full h-auto object-cover lg:mt-14'
              />
