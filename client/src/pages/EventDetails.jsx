            ...
            <ul className='flex items-center'>
              <li className='inline-flex items-center'>
                <Link to='/' className='text-gray-900 hover:text-[#B33D53]'>
                  <svg
                    className='w-5 h-auto fill-current mx-1 text-gray-900'
            ...
            <div className='relative flex items-center justify-center w-full'>
              {allAboutEvent.event_banner_url && (
                <div style={{ maxWidth: "40%", margin: "0 auto" }}>
                  <img
                    src={allAboutEvent.event_banner_url}
                    alt=''
                    className='w-full h-[80px] lg:h-[160px]'
                    style={{ display: "block" }} // Ensures the image is displayed as a block element
                  />
                </div>
              )}
            ...
            <div className='flex flex-col-reverse lg:flex-row lg:w-full mx-2'>
              <div className='w-full lg:w-1/4 flex flex-col gap-5 text-sm items-center lg:pt-5'>
                ...
                <div className='min-w-full flex flex-col gap-2 shadow-boxshadow rounded-lg p-5 bg-white'>
                  ...
                  {eventData &&
                    eventData?.slice(0, 2).map((ele, index) => {
                      return (
                        <div
                          key={index}
                          className='w-full cursor-pointer list-disc bg-white rounded-lg flex gap-3 text-justify'
                        >
                  ...
                  <div className='bg-white flex flex-col gap-2 py-5 rounded-lg font-[16px]'>
                    ...
                    <div className='flex justify-between items-center'>
                      ...
                      <span>
                        {
                          eventData.filter(function (item) {
              ...
              <div className='w-full lg:w-3/4 h-full flex flex-col gap-5'>
                <div className='lg:p-4 pt-0 pl-0 lg:pl-5 text-xl lg:text-3xl font-bold'>
                  Browse Top {event} Shopping Events
                </div>
              ...
              <form className='w-56 max-w-screen-lg lg:w-96 mx-auto'>
                <div className='mb-4 flex flex-col gap-6  items-center justify-center'>
                  ...
                  <span className='text-sm text-gray-500'>
                    Password must be 8 characters or more, Don&apos;t use any
                    part of your email, Don&apos;t use a common password
                  </span>
                </div>
                <Button
