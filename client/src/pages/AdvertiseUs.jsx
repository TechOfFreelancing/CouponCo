...
const AdvertiseUs = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // if (!UserData) return toast.error("Please login your account")
    ...
    return (
      <>
        ...
        <div className='px-5 max-w-[1280px] mx-auto flex flex-col text-black mt-28 mb-5 lg:mt-32 items-start gap-5'>
          <div className='flex flex-col items-start flex-wrap lg:p-5 lg:pb-0'>
            ...
            <span className='text-xl lg:text-2xl font-bold lg:ml-2 mt-5'>
              Advertise With Us
            </span>
          </div>
          <div className='w-full lg:ml-2 lg:p-5 lg:pt-0 text-lg lg:-mt-20'>
            <img
              className='lg:float-right w-full  lg:w-[45%] h-auto lg:m-10 lg:mt-0 lg:mr-0'
              src={img1}
            />
            <p className='text-justify lg:mt-20'>
              At Qwik Savings, we offer prime advertising opportunities to
              elevate your brand visibility. Partner with us to showcase your
              products or services to our engaged audience of thousands.
            </p>
            <div className='text-xl lg:text-2xl font-semibold my-5'>
              Why Advertise With Us?
            </div>
            <ul className='ml-5 list-disc text-justify'>
              {ads.map((ele, index) => (
                <li key={index} className='my-5'>
                  <span className='font-semibold whitespace-nowrap inline'>
                    {ele.text}:
                  </span>
          ...
          <div className='contactform flex justify-between items-center w-fit p-5 lg:p-10 shadow-boxshadow rounded-lg bg-white lg:mx-5 lg:mt-5 lg:mb-10'>
            <div className='w-full flex flex-col gap-5'>
              ...
              <div className='text-justify'>
                Fill out the form below to kickstart your advertising journey
                with Qwik Savings. Let{`'`}s collaborate and create impactful
              ...
              <button
                ...
                className='whitespace-nowrap bg-[#B33D53] px-4 py-2 text-white rounded-md hover:-translate-y-1 duration-300 w-fit'
              >
                Submit Form
              </button>
            </div>
