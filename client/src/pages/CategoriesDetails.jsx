                    ...
                    <div className="flex flex-col-reverse lg:flex-row">
                        <div className="w-full lg:w-1/4 h-full flex flex-col gap-5 px-5 text-sm items-center">
                            ...
                            <div className="shadow-boxshadow rounded-lg p-5 bg-white">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {
                                        couponDetails.map((ele, index) => <div key={index} className="cursor-pointer text-sm p-1 duration-300  bg-gray-300 hover:bg-red-200 rounded-md"
                                            onClick={() => {
                ...
                <div className="flex flex-col items-center" onClick={handleInsideClick}>
                    <div className="h-3/4  flex flex-col gap-3 lg:gap-5 items-center">
                        ...
                        {copySuccess && <div className="text:sm lg:text-lg text-green-800">
                            ...
                            <a href={correctedRefLink} target="_blank" rel="noopener noreferrer" className="underline text-[#800000] hover:cursor-pointer">
