      ...
      <div className='px-5 max-w-[1280px] mx-auto flex flex-col text-black mt-28 lg:mt-32 items-start gap-5'>
        <div className='flex flex-col lg:flex-row gap-5 w-full relative items-start'>
          ...
          <div className='flex flex-col w-full lg:w-[70%] gap-5 text-justify scrollbar-none lg:p-5'>
            <div>
              <div className='text-xl lg:text-2xl font-bold lg:ml-2 text-start'>
            ...
            <div className='lg:pl-2 flex flex-col gap-3'>
              ...
              <div className='flex flex-col gap-2 text-gray-800'>
                ...
                <span>
                  ...
                  whether through a bot, script, or otherwise; (5) you will not
                  use the Site for any illegal or unauthorized purpose; and (6)
              ...
              <div className='flex flex-col gap-2 text-gray-800'>
                <span className='font-semibold text-lg text-black' id='q5'>
              ...
              <div className='flex flex-col gap-2 text-gray-800'>
                ...
                <div className='flex flex-col gap-4'>
                  <span>
                    ...
                    Online Privacy Protection Act, if we receive actual
                    knowledge that anyone under the age of 13 has provided
              ...
              <div className='flex flex-col gap-2 text-gray-800'>
                ...
                <span>
                  ...
                  IN THE SITE OR DELETE ANY CONTENT OR INFORMATION THAT YOU
              ...
              <div className='flex flex-col gap-2 text-gray-800' id='q13'>
                ...
                <span>
                  ...
                  performed withinthe State of California, without regard to its
              ...
              <div className='flex flex-col gap-2 text-gray-800' id='q14'>
                ...
                <span>
                  ...
                  courts located inThe United States of America,California, and
                  the Parties hereby consent to, and waive all defenses of lack
              ...
              <div className='flex flex-col gap-2 text-gray-800' id='q17'>
                ...
                <span>
                  ...
                  AMOUNT PAID, IF ANY, BY YOU TO USDURING THE TWELVE (12) MONTH
