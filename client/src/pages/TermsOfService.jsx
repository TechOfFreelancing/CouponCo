      ...
      <div className="px-5 max-w-[1280px] mx-auto flex flex-col text-black mt-28 lg:mt-32 items-start gap-5">
        ...
        <div className="flex flex-col lg:flex-row gap-5 w-full relative items-start">
          ...
          <div className="flex flex-col w-full lg:w-[70%] gap-5 text-justify scrollbar-none lg:p-5">
            <div>
              <div className="text-xl lg:text-2xl font-bold lg:ml-2 text-start">Terms of Service of Qwik Savings</div>
              <div className="text-sm lg:ml-2 text-gray-800 mt-2">Last updated January 06, 2023</div>
            </div>

            <div className="lg:pl-2 flex flex-col gap-3">
              ...
              <ol className="list-decimal ml-5 text-[#B33D53] flex flex-col gap-2 justify-start">
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q1"
                    ...
                    smooth={true}
                    offset={-150}
                    duration={800}>AGREEMENT TO TERMS</Link1>
                </li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q2"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>INTELLECTUAL PROPERTY RIGHTS
                  </Link1>
                </li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q3"
                    ...
                    smooth={true}
                    offset={-150}
                    duration={800}>USER REPRESENTATIONS</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q4"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>PROHIBITED ACTIVITIES</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q5"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>USER GENERATED CONTRIBUTIONS
                  </Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q6"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>CONTRIBUTION LICENSE
                  </Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q7"
                    spy={true}
                ...
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q9"
                    ...
                    smooth={true}
                    offset={-150}
                    duration={800}>SITE MANAGEMENT</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q10"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>PRIVACY POLICY</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q11"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>TERM AND TERMINATION
                  </Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q12"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>MODIFICATIONS AND INTERRUPTIONS</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q13"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>GOVERNING LAW</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q14"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>DISPUTE RESOLUTION</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q15"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>CORRECTIONS</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q16"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>DISCLAIMER</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q17"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>LIMITATIONS OF LIABILITY</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q18"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>INDEMNIFICATION</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q19"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>USER DATA</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q20"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q21"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>CALIFORNIA USERS AND RESIDENTS</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q22"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>MISCELLANEOUS</Link1></li>
                <li className="cursor-pointer hover:underline duration-300 text-start">
                  <Link1 to="q23"
                    spy={true}
                    smooth={true}
                    offset={-150}
                    duration={800}>CONTACT US </Link1></li>

              </ol>
              <div className="flex flex-col gap-2 text-gray-800 text-justify">
                <span className="font-semibold text-lg text-black" id="q1">1. Agreement to Terms</span>
                <span>
                  These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Qwik Savings (<span className="font-semibold">“Company,” “we,” “us,” or “our“</span>), concerning your access to and use of the <Link to="https://www.qwiksavings.com/" className="text-[#B33D53]">https://www.qwiksavings.com</Link> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use.
                </span>
                <span>
              ...
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q2">2. Intellectual Property Rights</span>
                <span>
              ...
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q3">3. User Representations</span>
                <span>By using the Site, you represent and warrant that:(1) you have the legal capacity and you agree to comply with these Terms of Use;(2) you are not under the age of 13; (3) you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use the Site; (4) you will not access the Site through automated or non-human means, whether through a bot, script, or otherwise; (5) you will not use the Site for any illegal or unauthorized purpose; and (6) your use of the Site will not violate any applicable law or regulation.</span>
                <span>
                  If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof).
                </span>
              </div>
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q4">4. Prohibited Activities</span>
                <span>You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
                </span>
                ...
                <ul className="flex flex-col gap-2 list-disc ml-5">
                  ...
                  <li> Interfere with, disrupt, or create an undue burden on the Site or the networks or services connected to the Site.
                    Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any portion of the Site to you.</li>
              ...
              <div className="flex flex-col gap-2 text-gray-800" id="q6">
                ...
                <span>By submitting suggestions or other feedback regarding the Site, you agree that we can use and share such feedback for any purpose without compensation to you.</span>
                <span>
                  We do not assert any ownership over your Contributions. You retain full ownership of all of your Contributions and any intellectual property rights or other proprietary rights associated with your Contributions. We are not liable for any statements or representations in your Contributions provided by you in any area on the Site. You are solely responsible for your Contributions to the Site and you expressly agree to exonerate us from any and all responsibility and to refrain from any legal action against us regarding your Contributions.
                </span>
              </div>
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q7">7. Submissions</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q8">8. Advertisers</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q9">9. Site Management</span>
                <span>
              ...
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q10">10. Privacy Policy</span>
                <div className="flex flex-col gap-4">
                  <span>
                    We care about data privacy and security. Please review our Privacy Policy:https://www.Qwik Savings.com/privacy-policy/. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States. Further, we do not knowingly accept, request, or solicit information from children or knowingly market to children. Therefore, in accordance with the U.S. Children’s Online Privacy Protection Act, if we receive actual knowledge that anyone under the age of 13 has provided personal information to us without the requisite and verifiable parental consent, we will delete that information from the Site as quickly as is reasonably practical.
                  </span>
                </div>
              </div>
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q11">11.Term and Termination</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800">
                <span className="font-semibold text-lg text-black" id="q12">12.Modifications and Interruptions</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800" id="q13">
                <span className="font-semibold text-lg text-black">13. Governing Law</span>
                <span>These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of the State of California applicable to agreements made and to be entirely performed withinthe State of California, without regard to its conflict of law principles.</span>
              </div>
              <div className="flex flex-col gap-2 text-gray-800" id="q14">
                <span className="font-semibold text-lg text-black">14. Dispute Resolution</span>
                <span>Any legal action of whatever nature brought by either you or us (collectively, the “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and federal courts located inThe United States of America,California, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use.</span>
              </div>
              <div className="flex flex-col gap-2 text-gray-800" id="q15">
                <span className="font-semibold text-lg text-black">15. Corrections</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800" id="q16">
                <span className="font-semibold text-lg text-black">16. Disclaimer</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800" id="q17">
                <span className="font-semibold text-lg text-black">17. Limitations of Liability</span>
                <span>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO USDURING THE TWELVE (12) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.</span>
              </div>
              <div className="flex flex-col gap-2 text-gray-800" id="q18">
                <span className="font-semibold text-lg text-black">18. Indemnification</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800" id="q19">
                <span className="font-semibold text-lg text-black">19. User Data</span>
                <span>We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</span>
              </div>
              <div className="flex flex-col gap-2 text-gray-800" id="q20">
                <span className="font-semibold text-lg text-black">20. Electronic Communications, Transactions, and Signatures</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800" id="q21">
                <span className="font-semibold text-lg text-black">21. California Users and Residents</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800" id="q22">
                <span className="font-semibold text-lg text-black">22. Miscellaneous</span>
              ...
              <div className="flex flex-col gap-2 text-gray-800" id="q23">
                <span className="font-semibold text-lg text-black">23.Contact Us </span>
                <span>In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please write us at: <Link to="mailto:contact@qwiksavings.com" className="text-[#B33D53]">contact@qwiksavings.com.</Link>.</span>
              </div>
