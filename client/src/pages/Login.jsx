...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const res = await axios.post("process.env.URL/api/login", {
                email,
                password
            })
                ...
                <div className="bg-white p-10 rounded-xl border flex flex-col gap-5 my-10">
                    ...
                    <form className="w-80 max-w-screen-lg lg:w-96 mx-auto">
                        ...
                        <Typography color="gray" className="mt-2 mx-auto font-normal">
                            <Link to="process.env.URL/api/forgot-password" className=" underline font-medium transition-colors hover:text-orange-700">
