        ...
        <>
            <div className='lg:w-[75vw] flex flex-col text-black border lg:mx-auto mt-20 lg:mt-32'>
                <div className="p-4 flex flex-col items-start flex-wrap">
                    ...
                    <div className='font-semibold text-lg lg:text-3xl mt-5 ml-2' style={{ fontWeight: 600 }}>Browse Top Shopping Events</div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 p-5">
                    {
                        event.map((ele, index) => {
                            return <div key={index} className='flex flex-col items-center justify-center gap-3 space-y-4 h-[335px] w-auto border shadow-lg rounded-xl p-5 bg-white'>
                                ...
                                <Link to="/eventdetails" className='bg-black text-white py-2 w-[200px] rounded-lg flex text-center justify-center'>Reveal Offer</Link>
