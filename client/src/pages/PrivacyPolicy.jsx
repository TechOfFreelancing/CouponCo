        ...
        <div className='px-5 max-w-[1280px] mx-auto flex flex-col text-black mt-28 lg:mt-32 items-start gap-5'>
          <div className='flex flex-col lg:flex-row gap-5 w-full relative items-start'>
            <div className='flex flex-col w-full lg:w-[30%] lg:p-5 lg:pl-0 lg:ml-10 gap-5 text-[#B33D53] lg:sticky lg:top-32 lg:h-screen'>
              <div className='flex flex-col items-start flex-wrap pb-0 -lg:ml-2'>
                <ul className='flex items-center'>
                  <li className='inline-flex items-center'>
                    ...
                    <span className='mx-4 h-auto text-black font-medium'>
                      /
                    </span>
                  </li>
              ...
              <div className='font-semibold text-xl text-black lg:h-10'>
                About QwikSavings.com{" "}
              </div>
              <hr className='border-2' />
              <Link
                to='/aboutus'
                className='cursor-pointer hover:underline duration-300 text-start w-fit'
              >
                Our Company
              </Link>
              <Link
            ...
            <div className='flex flex-col w-full lg:w-[70%] gap-10 text-justify scrollbar-none lg:p-5'>
              <div>
                <div className='text-xl lg:text-2xl font-bold lg:ml-2 lg:mt-5'>
                  Privacy Policy of Qwik Savings
                </div>
                <div className='text-sm lg:ml-2 text-gray-800 mt-2'>
              ...
              <div className='lg:pl-2 flex flex-col gap-2'>
                ...
                <div className='text-gray-800 text-justify'>
                  This policy is to make aware all the visitors of our site
                  about what information we collect, use, and store provided by
                  the user. By ‘user’ or ‘you/r’ we mean someone who uses our
                  service. If you are accessing our site and using the service
                  on behalf of a company or a legal entity, ‘ ‘user’ or you/r is
                  that company or legal entity in that case. Moreover, any
                  gender words in one gender refer to all genders, and words in
                  singular refer to plural and vice-versa.
                </div>
              </div>
              <div className='lg:pl-2 flex flex-col gap-2'>
                ...
                <div className='text-gray-800 text-justify flex flex-col gap-3'>
                  <div>
                    ...
                    and/or share (
                    <span className='font-semibold'>“process“</span>) your
                    information when you use our services (
                    <span className='font-semibold'>“Services“</span>), such as
                    when you:
                  </div>
                  ...
                  <ul className='list-disc ml-5'>
                    <li>
                      ...
                      <Link
                        to='https://www.qwiksavings.com/'
                        className='text-[#B33D53]'
                      >
                  ...
                  <div>
                    ...
                    at{" "}
                    <Link
                      to='mailto:contact@qwiksavings.com'
                      className='text-[#B33D53]'
                    >
              ...
              <div className='lg:pl-2 flex flex-col gap-4'>
                ...
                <span className='text-gray-800 text-start lg:text-justify font-semibold italic'>
                  ...
                  <Link1
                    ...
                    offset={-150}
                    duration={800}
                    className='text-[#B33D53] font-normal cursor-pointer ml-1'
                  >
                    here
                  </Link1>{" "}
                ...
                <span className='text-gray-800 text-start lg:text-justify'>
                  ...
                  contact us form available on website, or by contacting us
                  through email at{" "}
                  <Link
                    to='mailto:privacy@qwiksavings.com'
                    className='text-[#B33D53]'
                  >
              ...
              <div className='lg:pl-2 flex flex-col gap-10'>
                <div className='font-semibold text-lg' id='q'>
                  TABLE OF CONTENTS
                </div>
                ...
                <div className='flex flex-col gap-2 text-gray-800 text-justify'>
                  <span className='font-semibold text-lg text-black' id='q1'>
                    ...
                    <div className='flex flex-col gap-2'>
                      ...
                      <ul className='list-disc flex flex-col gap-2 ml-5 italic'>
                        ...
                        <li>
                          ...
                          other device you use to access the Services. Depending
                          ...
                          location, browser type, hardware model, Internet
                          service provider and/or mobile carrier, operating
                        ...
                        <li>
                          ...
                          you use to access the Services. For example, we may
                          use GPS and other technologies to collect geolocation
                          data that tells us your current location (based on
                          your IP address). You can opt out of allowing us to
                          collect this information either by refusing access to
                          the information or by disabling your Location setting
                          on your device. However, if you choose to opt out, you
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q2'>
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q3'>
                  ...
                  <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-4'>
                      <span className='font-semibold text-gray-800 underline italic'>
                      ...
                      <ul className='flex flex-col list-disc gap-2 ml-5'>
                        <li>
                          <span>
                            ...
                            <Link1 className='text-[#B33D53] font-normal cursor-pointer ml-1'>
                              here
                            </Link1>{" "}
                            to learn more.
                          </span>
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q4'>
                  ...
                  <div className='flex flex-col gap-4'>
                    <span>
                      ...
                      <i>
                        ...
                        third parties. We may need to share your personal
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q7'>
                  ...
                  <div className='flex flex-col gap-4'>
                    ...
                    <span>
                      ...
                      requirements). When we have no ongoing legitimate business
                      need to process your personal information, we will either
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q8'>
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q9'>
                  ...
                  <div className='flex flex-col gap-4'>
                    <span>
                      ...
                      <i>
                        ...
                        (EEA), United Kingdom (UK), and Canada, you have rights
                    ...
                    <span>
                      ...
                      section{" "}
                      <span className='hover:underline cursor-pointer italic text-[#B33D53]'>
                        “HOW CAN YOU CONTACT US ABOUT THIS NOTICE?”
                      </span>{" "}
                      below.
                    </span>
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q10'>
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q11'>
                    ...
                    <table className='table-fixed border-black bg-white w-full'>
                      <thead className='border border-black'>
                        <tr className='border border-black text-center'>
                          <th className='border-l border-black w-[30%] lg:p-5'>
                            Category
                          </th>
                          <th className='border-l border-black w-[50%] lg:p-5'>
                            Examples
                          </th>
                          <th className='border-l border-black w-[20%] lg:p-5'>
                            Collected
                          </th>
                        </tr>
                      </thead>
                      <tbody className='border border-black text-start'>
                        <tr className='border border-black'>
                          <td className='border-l border-black lg:p-5'>
                            A. Identifiers
                          </td>
                          ...
                          <td className='border-l border-black p-2 lg:p-5 text-center'>
                            NO
                          </td>
                        </tr>
                        <tr className='border border-black'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <span>
                      ...
                      purpose in the preceding twelve (12) months. CodeSpotr
                ...
                <div className='flex flex-col gap-2 text-gray-800'>
                  <span className='font-semibold text-lg text-black' id='q12'>
                ...
                <span className='font-semibold text-lg text-black'>
                  Note: We do not have control over the privacy policy of all
                  the sites listed on our website. Once you leave our site and
                  browse the store or service listed on our website they will
                  use information in accordance with their privacy policy. So we
                  request you to check the privacy policy of any store or
                  service website you visit from our website.{" "}
                </span>
              </div>
            </div>
          </div>
