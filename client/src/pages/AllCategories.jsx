        ...
        <div className="lg:w-[75vw] flex flex-col gap-5 text-black border lg:mx-auto mt-20 lg:mt-32 lg:p-10">
            ...
            <div>
                {selectedCategory === "All" ? (
                    uniqueAlphabets.map((letter, index) => (
                        <div key={index} className="border-2 border-gray-400 mb-3 py-3 cursor-pointer" onClick={() => { navigate("/AllStores", { state: { type: letter.filter } }) }}>
                            ...
                            <div className="lg:grid lg:grid-cols-3 gap-3 mx-3">
                                {Categories
                                    ...
                                    .map((category, i) => (
                                        <div key={i} className="px-5 py-3 font-thin bg-gray-200 mb-3 lg:mb-0">
                    ...
                    (letter, index) => (
                        <div key={index} className={`border-2 border-gray-400 mb-3 py-3 cursor-pointer ${selectedCategory === letter ? '' : 'hidden'}`} onClick={() => { navigate("/AllStores", { state: { type: letter.filter } }) }}>
                            <div className="text-4xl font-medium mx-5 my-2">{letter}</div>
                            <div className="lg:grid lg:grid-cols-3 gap-3 mx-3">
                                {Categories
